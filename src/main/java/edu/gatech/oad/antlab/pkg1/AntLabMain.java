 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Spencer Shaw");
		  toPrint += p1.toString("sshaw32");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Robert Cooper");
		  toPrint += p2.toString("rcooper39");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Matt Busch");
		  toPrint += p3.toString("rugshrub");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Lucille Wang");
                  toPrint += p4.toString("lucillewang");
